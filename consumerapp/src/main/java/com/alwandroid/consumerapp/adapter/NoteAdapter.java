package com.alwandroid.consumerapp.adapter;
...
import com.alwandroid.consumerapp.CustomOnItemClickListener;
import com.alwandroid.consumerapp.NoteAddUpdateActivity;
import com.alwandroid.consumerapp.R;
    ...
    public void onBindViewHolder(@NonNull NoteAdapter.NoteViewHolder holder, int position) {
        ...
        holder.cvNote.setOnClickListener(new CustomOnItemClickListener(position, new CustomOnItemClickListener.OnItemClickCallback() {
            ...
            public void onItemClicked(View view, int position) {
                ...
                activity.startActivityForResult(intent, NoteAddUpdateActivity.RESULT_UPDATE);
            }
        }));
    }
